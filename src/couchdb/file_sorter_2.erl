%%
%% The following is nearly verbatim copy of file_sorter.erl from
%% stdlib of Erlang R15B03-1. Only change we made on top is removal of
%% compressed option in call to file:open in read_fun below.
%%
%% ------------
%%
%% %CopyrightBegin%
