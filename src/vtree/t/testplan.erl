...
test_insert() ->
    ...
    Mbr1_2_3_4_5_6 = Mbr1_2_3_4_5_6_8 = Mbr1_2_3_4_5_6_9 = {-25,-32,19,19},
    ...
    % Tree3 isn't a real R-Tree as it has not enough nodes within its inner
    % nodes, but this should make testing easier and not break anything
    Tree3 = {Mbr1_2_3_4,
              [{Mbr1_2, [Node1, Node2]},
               {Mbr3_4, [Node3, Node4]}
              ]},
    Tree3Node5 = {Mbr1_2_3_4_5,
              [{Mbr1_2, [Node1, Node2]},
               {Mbr3_4_5, [Node3, Node4, Node5]}
              ]},
...
%            "Insert a nodes into a full leaf node (depth=2) (tie occurs)"),
...
test_best_split() ->
    ...
    etap:is(vtree:best_split(Partition3), tie,
