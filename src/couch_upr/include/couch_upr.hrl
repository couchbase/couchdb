...
-define(UPR_STATUS_NOT_SUPPORTED, 16#83).
-define(UPR_STATUS_TMP_FAIL, 16#86).
-define(UPR_SNAPSHOT_TYPE_MEMORY, 16#1).
-define(UPR_SNAPSHOT_TYPE_DISK, 16#2).
-define(UPR_SNAPSHOT_TYPE_CHK, 16#4).
-define(UPR_DATA_TYPE_RAW, 16#0).
-define(UPR_DATA_TYPE_JSON, 16#1).
-define(UPR_DATA_TYPE_RAW_COMPRESSED, 16#2).
-define(UPR_DATA_TYPE_JSON_COMPRESSED, 16#3).
