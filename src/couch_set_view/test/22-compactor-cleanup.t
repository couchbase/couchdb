...
test_set_name() -> <<"couch_test_set_index_compactor_cleanup">>.
num_set_partitions() -> 64.
ddoc_id() -> <<"_design/test">>.
num_docs_0() -> 27712.  % keep it a multiple of num_set_partitions()
...
test() ->
    ...
    {ok, CompactPid} = couch_set_view_compactor:start_compact(test_set_name(), ddoc_id()),
    ...
    etap:is(StatsAfter#set_view_group_stats.compactions, 1,
            "# of compactions is 1"),
