...
initial_num_docs() -> 160000.  % must be multiple of num_set_partitions()
...
query_reduce_view(Stale) ->
    ...
    {ok, View, Group} = couch_set_view:get_reduce_view(
        test_set_name(), ddoc_id(), <<"test">>, Stale),
...
verify_btrees_1(Group) ->
    ...
    etap:is(ViewUpdateSeqs, DbSeqs, "View0 has right update seqs list"),
